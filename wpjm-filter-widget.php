...
class WPJM_Filter_Widget extends WP_Widget {
    ...
    function widget( $args, $instance ) {
        ...
        $show_image = !empty($instance['show_image']) ? 1 : null;
        $show_company = !empty($instance['show_company']) ? 1 : null;
        $show_location = !empty($instance['show_location']) ? 1 : null;
        $show_type = !empty($instance['show_type']) ? 1 : null;
    ...
    function update( $new_instance, $old_instance ) {
        ...
        $instance['show_company'] = isset($new_instance['show_company']);
        $instance['show_location'] = isset($new_instance['show_location']);
...
?>
        ...
        <p>
            <input id="<?php echo $this->get_field_id('show_image'); ?>" name="<?php echo $this->get_field_name('show_image'); ?>" type="checkbox" <?php checked(isset($instance['show_image']) ? $instance['show_image'] : 0); ?> />&nbsp;<label for="<?php echo $this->get_field_id('show_image'); ?>"><?php _e('Hide Image?', 'wpjmfilter'); ?></label>
        </p>

        <p>
            <input id="<?php echo $this->get_field_id('show_company'); ?>" name="<?php echo $this->get_field_name('show_company'); ?>" type="checkbox" <?php checked(isset($instance['show_company']) ? $instance['show_company'] : 0); ?> />&nbsp;<label for="<?php echo $this->get_field_id('show_company'); ?>"><?php _e('Hide Company?', 'wpjmfilter'); ?></label>
        </p>

        <p>
            <input id="<?php echo $this->get_field_id('show_location'); ?>" name="<?php echo $this->get_field_name('show_location'); ?>" type="checkbox" <?php checked(isset($instance['show_location']) ? $instance['show_location'] : 0); ?> />&nbsp;<label for="<?php echo $this->get_field_id('show_location'); ?>"><?php _e('Hide Location?', 'wpjmfilter'); ?></label>
        </p>

        <p>
            <input id="<?php echo $this->get_field_id('show_type'); ?>" name="<?php echo $this->get_field_name('show_type'); ?>" type="checkbox" <?php checked(isset($instance['show_type']) ? $instance['show_type'] : 0); ?> />&nbsp;<label for="<?php echo $this->get_field_id('show_type'); ?>"><?php _e('Hide Job Types?', 'wpjmfilter'); ?></label>
        </p>
