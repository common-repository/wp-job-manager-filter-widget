...
Tags: wp job manager, wp job manager filter, wp job manager widget, filter jobs, sidebar jobs
...
* Option to Show/Hide by Image
* Option to Show/Hide by Company
* Option to Show/Hide by Location
* Option to Show/Hide by Job Types
...
= 3.0 =
* Added new features Show/Hide Image.
* Added new features Show/Hide Comapny.
* Added new features Show/Hide Location.
* Added new features Show/Hide Job Types.
...
= 2.0 =
Added new features Show/Hide: Image, Company, Location, Job Types